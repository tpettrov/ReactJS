    ...
    getBooks: () => {
        ...
        return new Promise((resolve, reject) =>{
            ...
            resolve([
                ...
                {id: 1, title: 'PHP', author: 'Me', date: new Date(2016,5,24), comments: [{id: 1, content: 'First comment'}, {id: 2, content: 'Second comment'}]},
                {id: 2, title: 'C#', author: 'Nakov', date: new Date(2002,5,24), comments: [{id: 1, content: 'First comment'}]},
