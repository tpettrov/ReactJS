...
var _NavabrUserMenu = require('./sub-components/NavabrUserMenu');

var _NavabrUserMenu2 = _interopRequireDefault(_NavabrUserMenu);
...
var Navbar = function (_React$Component) {
    ...
    _createClass(Navbar, [{
        ...
        value: function render() {
            ...
            var navbarUserMenu = _react2.default.createElement(_NavabrUserMenu2.default, { userData: this.props.userData });
...
},{"./sub-components/NavabrUserMenu":27,"react":"react","react-router":"react-router"}],25:[function(require,module,exports){
'use strict';
...
var NavabrUserMenu = function (_React$Component) {
    _inherits(NavabrUserMenu, _React$Component);

    function NavabrUserMenu(props) {
        _classCallCheck(this, NavabrUserMenu);

        var _this = _possibleConstructorReturn(this, (NavabrUserMenu.__proto__ || Object.getPrototypeOf(NavabrUserMenu)).call(this, props));
    ...
    return NavabrUserMenu;
}(_react2.default.Component);

exports.default = NavabrUserMenu;
